...
def _fallback_html_report(
    ...
    return f"""
    <div style="font-family: Arial, sans-serif; max-width: 900px; margin: 0 auto; color: #123;">
        <div style="background: linear-gradient(135deg, #1d4ed8, #059669); color: white; padding: 24px; border-radius: 16px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin: 24px 0;">
            <div style="padding: 16px; border: 1px solid #dbeafe; border-radius: 12px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    <th style="text-align:left; border-bottom: 1px solid #ddd; padding: 8px;">Round</th>
                    ...
                    <th style="text-align:left; border-bottom: 1px solid #ddd; padding: 8px;">Judges</th>
...
7. Use a modern blue and green visual style.
